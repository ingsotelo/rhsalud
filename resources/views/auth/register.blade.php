                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('R.F.C.') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-2">
                             ...
                             <div class="col-md-4">                   
                                <button type="button" class="btn btn-success" id="refresh"><i class="fas fa-sync-alt" ></i></button>
                                <span id="captcha_img">{!! Captcha::img(); !!}</span>
                            </div>
            ...
            $('#refresh').click(function(e){
               ...
               jQuery.ajax({
                  ...
                  success: function(result){
                    $('#captcha_img').html(result.captcha);
                  }});
               });
